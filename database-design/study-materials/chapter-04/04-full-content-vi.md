...
1. Giúp bạn **đảm bảo cấu trúc vững chắc và tính toàn vẹn dữ liệu**.
2. **Đúng.** Mức độ tính toàn vẹn cấu trúc tỷ lệ thuận trực tiếp với mức độ kỹ lưỡng bạn tuân theo quy trình thiết kế.
3. Mission statement **xác định mục đích** của cơ sở dữ liệu.
4. **Các phát biểu đại diện các nhiệm vụ chung** mà người dùng có thể thực hiện trên dữ liệu trong cơ sở dữ liệu.
5. **Danh sách trường và tính toán** bạn biên soạn trong giai đoạn thứ hai của quy trình thiết kế.
6. Từ **mission objectives** (giai đoạn một) và **yêu cầu dữ liệu** (giai đoạn hai).
7. **Sai.** Đặc tả trường được thiết lập trong giai đoạn **thứ ba**.
8. Bằng **khóa chính và khóa ngoại**, hoặc bằng **bảng liên kết**.
9. Cách tổ chức **nhận thức và sử dụng** dữ liệu của nó.
10. **Bảng xác thực**.
11. Bằng cách **phỏng vấn người dùng và quản lý** và xác định cách họ làm việc với dữ liệu tương ứng.
12. **Sau khi bạn đã hoàn thành toàn bộ quy trình thiết kế cơ sở dữ liệu**.
